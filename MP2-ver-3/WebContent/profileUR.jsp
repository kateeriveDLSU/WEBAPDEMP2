...
<title>Home</title>
<link rel="stylesheet" type="text/css" href="css/profileUR.css">
<script src="js/jquery-3.2.1.js"></script>
</head>
<body>
	<div class="nav">
		<a href="feedRecentUR.jsp"><img src="img/logov2.png"></a>
		<form action="searchUR.jsp" method="GET">
	...
	<div class="upperCon">
		<img src="img/profPic.png " class="profPic"> <span
			class="username">IisGOODboy</span>
		<p class="profDesc">This is my description. Who's a good boy? I
			AM!!!</p>
	</div>
	...
	<script src="js/profileUR.js"></script>
</body>
